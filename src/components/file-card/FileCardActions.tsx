...
export function FileCardActions({
  ...
  return (
    <div className="flex basis-full shrink-0 flex-wrap items-center justify-end gap-1 pt-2 sm:basis-auto sm:pt-0">
      {file.status === "pending" && showIndividualActions && (
        <>
          ...
          <Button size="sm" onClick={onConvert} aria-label="Start" className="ml-1 gap-1 sm:ml-2 sm:gap-2">
      ...
      {file.status === "completed" && (
        <div className="flex items-center gap-1">
          ...
          <Button
            ...
            onClick={onDownload}
            aria-label="Download"
            className="gap-1 bg-success text-success-foreground hover:bg-success/90 sm:gap-2"
          >
